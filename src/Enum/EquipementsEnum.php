...

{
    ...
    public function enumToString(): string
    {
        ...
        {
            // ARMORS
            self::ArmourFlak => EquipementstmpEnum::ArmourFlak->value,
            self::ArmourMesh => EquipementstmpEnum::ArmourMesh->value,
            self::ExoticArmourCarapace => EquipementstmpEnum::ExoticArmourCarapace->value,
            self::ExoticArmourForceField => EquipementstmpEnum::ExoticArmourForceField->value,

            // BIONICS
            self::BerserkerChip => EquipementstmpEnum::BerserkerChip->value,
            self::BionicArm => EquipementstmpEnum::BionicArm->value,
            self::BionicImplant => EquipementstmpEnum::BionicImplant->value,
            self::BionicLeg => EquipementstmpEnum::BionicLeg->value,
            self::BionicEye => EquipementstmpEnum::BionicEye->value,
            self::BionicTorso => EquipementstmpEnum::BionicTorso->value,
            self::LoboChip => EquipementstmpEnum::LoboChip->value,
            self::SkullChip => EquipementstmpEnum::SkullChip->value,

            // GANG_EQUIPEMENT
            self::HeavyGearAutoRepairer => EquipementstmpEnum::HeavyGearAutoRepairer->value,
            self::IsotropicFuelRod => EquipementstmpEnum::IsotropicFuelRod->value,
            self::MungVase => EquipementstmpEnum::MungVase->value,
            self::RaidGearScreamersOrStummers => EquipementstmpEnum::RaidGearScreamersOrStummers->value,
            self::RatskinMap => EquipementstmpEnum::RatskinMap->value,

            // PERSONAL_EQUIPMENT
            self::BioBooster => EquipementstmpEnum::BioBooster->value,
            self::BioScanner => EquipementstmpEnum::BioScanner->value,
            self::BlindSnakePouch => EquipementstmpEnum::BlindSnakePouch->value,
            self::ClipHarness => EquipementstmpEnum::ClipHarness->value,
            self::ConcealedBlade => EquipementstmpEnum::ConcealedBlade->value,
            self::FilterPlugs => EquipementstmpEnum::FilterPlugs->value,
            self::GravChute => EquipementstmpEnum::GravChute->value,
            self::Grapnel => EquipementstmpEnum::Grapnel->value,
            self::InfraRedGoggles => EquipementstmpEnum::InfraRedGoggles->value,
            self::MediPack => EquipementstmpEnum::MediPack->value,
            self::PhotoContacts => EquipementstmpEnum::PhotoContacts->value,
            self::PhotoVisor => EquipementstmpEnum::PhotoVisor->value,
            self::Respirator => EquipementstmpEnum::Respirator->value,
            self::StingerPouch => EquipementstmpEnum::StingerPouch->value,

            // WEAPON_EQUIPEMENT
            self::GunsightInfraRedSight => EquipementstmpEnum::GunsightInfraRedSight->value,
            self::GunsightMonoSight => EquipementstmpEnum::GunsightMonoSight->value,
            self::GunsightRedDotLaser => EquipementstmpEnum::GunsightRedDotLaser->value,
            self::GunsightTelescopicSight => EquipementstmpEnum::GunsightTelescopicSight->value,
            self::HeavyGearSuspensor => EquipementstmpEnum::HeavyGearSuspensor->value,
            self::RaidGearSilencer => EquipementstmpEnum::RaidGearSilencer->value,
            self::RareWeaponOneInAMillionWeapon => EquipementstmpEnum::RareWeaponOneInAMillionWeapon->value,
            self::WeaponReload => EquipementstmpEnum::WeaponReload->value,
        };
    }
