...
enum WeaponsEnum: string implements ItemEnumInterface
{
    ...
    function isCustomRules(): bool
    {
        return match ($this) {
            ...
            WeaponsEnum::AUTOPISTOL => false,
            WeaponsEnum::LASPISTOL => false,
            WeaponsEnum::HAND_FLAMER => false,
            WeaponsEnum::BOLT_PISTOL => false,
            WeaponsEnum::PLASMA_PISTOL => false,
            WeaponsEnum::PLASMA_PISTOL_LOW => false,
            WeaponsEnum::PLASMA_PISTOL_MAX => false,
            WeaponsEnum::NEEDLE_PISTOL => false,
            WeaponsEnum::WEB_PISTOL => false,
            // Basic Weapons
            WeaponsEnum::AUTOGUN => false,
            WeaponsEnum::SHOTGUN => false,
            ...
            WeaponsEnum::HUNTING_RIFLE => false,
            WeaponsEnum::LASGUN => false,
            WeaponsEnum::BOLTGUN => false,
            // Special Weapons
            WeaponsEnum::AUTOSLUGGER => false,
            WeaponsEnum::FLAMER => false,
            WeaponsEnum::GRENADE_LAUNCHER => false,
            WeaponsEnum::PLASMA_GUN => false,
            WeaponsEnum::PLASMA_GUN_LOW => false,
            WeaponsEnum::PLASMA_GUN_MAX => false,
            WeaponsEnum::MELTAGUN => false,
            WeaponsEnum::NEEDLE_RIFLE => false,
            // Heavy Weapons
            WeaponsEnum::HEAVY_FLAMER => false,
            WeaponsEnum::HEAVY_STUBBER => false,
            WeaponsEnum::HEAVY_BOLTER => false,
            WeaponsEnum::MISSILE_LAUNCHER => false,
            WeaponsEnum::HEAVY_PLASMA_GUN => false,
            WeaponsEnum::AUTOCANNON => false,
            WeaponsEnum::LASCANNON => false,
            // Hand-to-Hand Weapons
            WeaponsEnum::KNIFE => false,
            WeaponsEnum::CHAIN_FLAIL => false,
            WeaponsEnum::CLUB_MAUL_BLUDGEON => false,
            WeaponsEnum::MASSIVE_WEAPON => false,
            WeaponsEnum::SWORD => false,
            WeaponsEnum::CHAIN_SWORD => false,
            WeaponsEnum::POWER_AXE => false,
            WeaponsEnum::SHOCK_MAUL => false,
            WeaponsEnum::POWER_SWORD => false,
            WeaponsEnum::POWER_FIST => false,
            // Grenades
            WeaponsEnum::SMOKE_BOMBS => false,
            WeaponsEnum::CHOKE_GAS => false,
            WeaponsEnum::SCARE_GAS => false,
            WeaponsEnum::PHOTON_FLARES => false,
            WeaponsEnum::FRAG_GRENADE => false,
            WeaponsEnum::PLASMA_GRENADE => false,
            WeaponsEnum::KRAK_GRENADE => false,
            WeaponsEnum::MELTA_BOMBS => false,
            WeaponsEnum::HALLUCINOGEN_GAS => false,
            WeaponsEnum::FLARE_ROCKET => true,
            // Special Ammunitions
            WeaponsEnum::BOLT_SHELLS => false,
            WeaponsEnum::DUM_DUM_BULLETS => false,
            WeaponsEnum::HOT_SHOT_SHELLS => false,
            WeaponsEnum::MANSTOPPER_SHELLS => false,
            WeaponsEnum::MISSILE_LAUNCHER_FRAG => false,
            WeaponsEnum::MISSILE_LAUNCHER_KRAK => false,
            // Enfoncers
            WeaponsEnum::COMBAT_RIFLE => true,
            WeaponsEnum::COMBAT_RIFLE_SOLID_SHELLS => true,
            WeaponsEnum::COMBAT_RIFLE_SCATTER_SHELLS => true,
            WeaponsEnum::COMBAT_RIFLE_EXECUTIONER_SHELLS => true,
