...
class DownloadSheetController extends AbstractController
{
    ...
    public function generateGangTable(int $id): Response
    {
        ...
        $referenceValues = [
            ...
            GangerTypeEnum::heavy_unit->value => [
                'move' => 4,
                'weaponSkill' => 3,
                'ballisticSkill' => 3,
                'strength' => 3,
            ...
            GangerTypeEnum::special_unit->value => [
                'move' => 4,
                'weaponSkill' => 3,
                'ballisticSkill' => 3,
                'strength' => 3,
            ...
            GangerTypeEnum::canine_unit->value => [
                'move' => 4,
                'weaponSkill' => 3,
                'ballisticSkill' => 3,
                'strength' => 3,
            ...
            GangerTypeEnum::cyber_mastiff->value => [
                'move' => 6,
                'weaponSkill' => 3,
                'ballisticSkill' => 0,
                'strength' => 5,
    ...
    public function sortGangersByType(array $ListOfGangers): array
    {
        $order = [
            ...
            GangerTypeEnum::sergeant->value => 8,
            GangerTypeEnum::heavy_unit->value => 9,
            GangerTypeEnum::special_unit->value => 10,
            GangerTypeEnum::canine_unit->value => 11,
            GangerTypeEnum::cyber_mastiff->value => 12,
            GangerTypeEnum::enforcer->value => 13,
        ];
