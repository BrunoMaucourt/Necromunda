...
final class Version20240603180454 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE advancement ADD CONSTRAINT FK_9254210CE48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
        $this->addSql('ALTER TABLE advancement ADD CONSTRAINT FK_9254210C5585C142 FOREIGN KEY (skill_id) REFERENCES skill (id)');
    }
